...
class SocketHandler(socket.socket):
    ...
    def handshake(self) -> None:
        ...
        try:
            ...
            # Inizializza AES con la chiave del client
            self.crypto.New_AES(key=aes_key)

            # Get HMAC
            enc = conn.recv(64)

            # Ricevi TUTTI i bytes dell'HMAC
            while len(enc) < 64:
            ...
            # IMPORTANTE: usa lo stesso IV del client per decifrare
            ...
            # Usa la stessa HMAC key del client
